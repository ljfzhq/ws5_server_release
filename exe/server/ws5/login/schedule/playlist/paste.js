...
var PasteScheduleItems = function() {
	...
	this.do = function(req, res) {
		...
		logger.debug('enter schedule/playlist/paste.js');
		dataObj = req.body;
console.log('request data for paste playlist:');
...
console.log('req.session.pastePlaylistData='+req.session.pastePlaylistData);
...
//console.log(targetPlaylistArray);
																...
																schedule.batchInsertPlaylist(targetPlaylistArray, function(err) {
																	if(err) {
																		...
																		retVal.status = true;
																		logger.debug('return from schedule/playlist/paste.js');
